...
<head>
    ...
    <title>MPC Grading System | Class list</title>
        ...
        <div class="wrapper wrapper-content animated fadeInRight">
            <div class="row">
                ...
                <div class="ibox ">
                    ...
                    <tbody>
                    <tr class="gradeX">
                        <td>CASILAGAN, JOHNREY</td>
                        <td style="text-align: center; padding: 10px;"><input type="text" name="name" class="form-control text-center w-50"  style="width: 50%; margin: 0 auto;"></td>
                        <td style="text-align: center; padding: 10px;"><input type="text" name="name" class="form-control text-center w-50"  style="width: 50%; margin: 0 auto;"></td>
                        <td style="text-align: center; padding: 10px;"><input type="text" name="name" class="form-control text-center w-50"  style="width: 50%; margin: 0 auto;"></td>
